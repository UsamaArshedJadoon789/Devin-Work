        ...
        <div className="w-full max-w-2xl lg:max-w-4xl relative">
          <div className="relative z-10 mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              ...
              >
                <Button 
                  className="w-full bg-[#C6F135] hover:bg-[#D4F55C] text-black font-semibold text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 rounded-full transition-colors duration-300"
                >
              ...
              >
                <Button 
                  variant="ghost"
                  className="w-full text-white hover:bg-white/10 text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 rounded-full border border-white/20 transition-colors duration-300 flex items-center justify-center gap-2"
                >
