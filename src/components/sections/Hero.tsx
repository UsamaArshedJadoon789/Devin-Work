...
export const Hero: FC = () => {
  return (
    <ParallaxBackground>
      ...
      <div className="container flex-1 flex items-center justify-center relative z-10">
        <div className="w-full max-w-2xl lg:max-w-4xl relative">
          <div className="relative z-10">
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white leading-[1.1] animate-fade-in animate-duration-700">
              We Build SEO Revenue Engines For SaaS Brands
            </h1>
            <p className="text-lg sm:text-xl text-gray-300 max-w-2xl animate-fade-in animate-slide-up animate-delay-200 animate-duration-500">
        ...
        <div className="absolute top-[45%] -right-[15%] w-[420px] rounded-2xl bg-[#0F1923] shadow-2xl transform rotate-3 hover:rotate-0 transition-all duration-700 hover:shadow-2xl hover:scale-105 transform-gpu">
          ...
          <div className="space-y-6">
            <div className="bg-[#1A2730]/50 rounded-xl">
