        ...
        <div className="w-full max-w-2xl lg:max-w-4xl relative">
          <div className="relative z-10 mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate-fade-in animate-slide-up animate-delay-300 animate-duration-500">
              ...
              <Button 
                variant="ghost" 
                className="group inline-flex items-center gap-2 w-full sm:w-auto text-white hover:bg-white/10 hover:scale-105 text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 rounded-full border border-white/20 transition-all duration-500"
              >
