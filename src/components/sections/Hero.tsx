      ...
      <div className="container mx-auto px-4 flex-1 flex items-center justify-center relative z-10">
        <div className="w-full max-w-2xl lg:max-w-4xl relative">
          ...
          >
            ...
            >
              <Button 
                className="w-full sm:w-auto bg-[#C6F135] hover:bg-[#D4F55C] text-black font-semibold text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 rounded-full transition-colors duration-300 hover:scale-105"
              >
                Book a Strategy Call
              </Button>
              <Button 
                variant="ghost" 
                className="w-full sm:w-auto text-white hover:bg-white/10 text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 rounded-full border border-white/20 transition-colors duration-300 hover:scale-105"
              >
